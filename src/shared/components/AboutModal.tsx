  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-gray-900 border border-white/10 rounded-3xl p-8 max-w-lg w-full shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <p className="text-indigo-300 text-sm mb-6">Trabalho de PRJ</p>
        ...
        <div className="space-y-4 text-gray-300 text-sm">
          ...
          <div className="bg-white/5 p-4 rounded-xl border border-white/5">
            ...
            <ul className="list-disc list-inside">
              <li>Lucas Rispoli Delgado</li>
              <li>Matheus Wayand Grotz</li>
              <li>Vitor Luiz Maiworm Justen</li>
            </ul>
          </div>
          ...
          <div className="bg-white/5 p-4 rounded-xl border border-white/5">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <span className="px-2 py-1 bg-blue-800/20 text-indigo-300 rounded-md text-xs">
                Java
              </span>
              <span className="px-2 py-1 bg-blue-800/20 text-indigo-300 rounded-md text-xs">
                Spring Boot
