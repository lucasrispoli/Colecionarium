...
export default function AlbumBook({ isAuthor }: Props) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const sortedPages = fetchedPages.sort(
        (a, b) => a.numberPage - b.numberPage,
      );
    ...
    <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 mt-4 sm:mt-0">
            ...
            <div className="flex gap-2 border-l border-gray-200 dark:border-gray-700 pl-4">
              <button 
                ...
                className="px-3 py-1.5 text-sm bg-blue-700 text-white rounded-lg hover:bg-blue-400 disabled:opacity-50 transition-colors font-medium"
              >
                Editar
              </button>
              <button 
                ...
                className="px-3 py-1.5 text-sm bg-red-700 text-white rounded-lg hover:bg-red-400 disabled:opacity-50 transition-colors font-medium"
              >
                Excluir
              </button>
            </div>
            ...
            <button
              ...
              className="px-4 py-1.5 text-sm bg-white rounded-lg hover:bg-gray-300 transition-colors font-medium ml-2"
            >
              Nova Página
            </button>
          </div>
        ...
        {currentPage ? (
            ...
            <div className="w-full max-w-4xl grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
              ...
              {isAuthor && (
                <button
                  ...
                  className="aspect-[3/4] border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex flex-col items-center justify-center text-gray-400 hover:text-blue-800 hover:border-blue-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all group"
                >
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-20">
            ...
            {isAuthor && (
              <button
                onClick={handleCreatePage}
                className="mt-6 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-blue-800/30"
              >
      ...
      {isDetailOpen && stickerToDetail && (
        <StickerDetailModal
          ...
          pageName={
            pages.find((p) => p.id === stickerToDetail.pageId)?.name ||
            "Desconhecida"
          }
